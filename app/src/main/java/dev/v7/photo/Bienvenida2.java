...
import dev.v7.photo.databinding.ActivityBienvenida2Binding;
...
public class Bienvenida2 extends AppCompatActivity {
    ...
    private ActivityBienvenida2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent login = new Intent(Bienvenida2.this,Login.class);
                startActivity(login);
            }
        });
        binding.button2.setOnClickListener(v -> {

            Intent resgistro = new Intent(Bienvenida2.this,Registro.class);
            startActivity(resgistro);
        });
        autentificador = FirebaseAuth.getInstance();
        if(checkUser()){
            Intent main = new Intent(Bienvenida2.this,MainActivity.class);
            startActivity(main);
        }
    }
